...
// Contoh 9 pertanyaan gaya PHQ/DASS (parafrase)
const List<Question> defaultQuestions = <Question>[
  ...
  // --- INI PERTANYAAN BARU (q3 - q8) ---

  Question(
    id: 'q3',
    text: 'Merasa cemas, gugup, atau tegang secara berlebihan?',
    options: [
      AnswerOption(label: 'Tidak Pernah', score: 0),
      AnswerOption(label: 'Beberapa Hari', score: 1),
      AnswerOption(label: 'Lebih dari Separuh Hari', score: 2),
  ...
  Question(
    id: 'q4',
    text: 'Tidak dapat menghentikan atau mengendalikan rasa khawatir?',
    options: [
      AnswerOption(label: 'Tidak Pernah', score: 0),
      AnswerOption(label: 'Beberapa Hari', score: 1),
      AnswerOption(label: 'Lebih dari Separuh Hari', score: 2),
  ...
  Question(
    id: 'q5',
    text: 'Kesulitan tidur, tidur tidak nyenyak, atau terlalu banyak tidur?',
    options: [
      AnswerOption(label: 'Tidak Pernah', score: 0),
      AnswerOption(label: 'Beberapa Hari', score: 1),
      AnswerOption(label: 'Lebih dari Separuh Hari', score: 2),
  ...
  Question(
    id: 'q6',
    text: 'Merasa buruk tentang diri sendiri (merasa gagal atau mengecewakan)?',
    options: [
      AnswerOption(label: 'Tidak Pernah', score: 0),
      AnswerOption(label: 'Beberapa Hari', score: 1),
      AnswerOption(label: 'Lebih dari Separuh Hari', score: 2),
  ...
  Question(
    id: 'q7',
    text: 'Sulit berkonsentrasi pada sesuatu, seperti membaca atau menonton TV?',
    options: [
      AnswerOption(label: 'Tidak Pernah', score: 0),
      AnswerOption(label: 'Beberapa Hari', score: 1),
      AnswerOption(label: 'Lebih dari Separuh Hari', score: 2),
  ...
  Question(
    id: 'q8',
    text: 'Merasa mudah tersinggung atau jengkel?',
    options: [
      AnswerOption(label: 'Tidak Pernah', score: 0),
      AnswerOption(label: 'Beberapa Hari', score: 1),
      AnswerOption(label: 'Lebih dari Separuh Hari', score: 2),
